  ...
  return (
    ...
    <Navbar />
      <div style={{ background: "#15141F" }}>
        ...
        <div
          className={`${nunito.className} ${styles.descriptionBox}`}
        >
          ...
          <p className={styles.description}>
            ...
            Eius sint, placeat dolore quisquam expedita tempora
            maiores, dolorem impedit debitis nesciunt quidem quas
            cumque beatae ducimus suscipit illum vero ea distinctio
            veritatis autem, provident doloremque at.
          </p>
        </div>
